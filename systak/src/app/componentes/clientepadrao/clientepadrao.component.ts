...
@Component({
  selector: 'app-clientepadrao',
  templateUrl: './clientepadrao.component.html',
  styleUrls: ['./clientepadrao.component.css']
})
export class ClientepadraoComponent implements OnInit {
